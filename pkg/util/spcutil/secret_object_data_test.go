...
func assertSecretsObjectsEqual(expected, actual *v1alpha1.SecretObject) bool {
...
func assertSecretObjectSlicesEqual(expected, actual []*v1alpha1.SecretObject) bool {
