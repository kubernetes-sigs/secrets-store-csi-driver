...
var secretproviderclasspodstatusesResource = schema.GroupVersionResource{Group: "secrets-store.csi.x-k8s.io", Version: "v1alpha1", Resource: "secretproviderclasspodstatuses"}
...
func (c *FakeSecretProviderClassPodStatuses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SecretProviderClassPodStatus, err error) {
	...
	return obj.(*v1alpha1.SecretProviderClassPodStatus), err
}
...
func (c *FakeSecretProviderClassPodStatuses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SecretProviderClassPodStatusList, err error) {
	...
	list := &v1alpha1.SecretProviderClassPodStatusList{ListMeta: obj.(*v1alpha1.SecretProviderClassPodStatusList).ListMeta}
	for _, item := range obj.(*v1alpha1.SecretProviderClassPodStatusList).Items {
