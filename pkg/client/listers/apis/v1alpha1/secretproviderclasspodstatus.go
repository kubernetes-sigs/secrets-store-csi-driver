...
type SecretProviderClassPodStatusLister interface {
	...
	List(selector labels.Selector) (ret []*apisv1alpha1.SecretProviderClassPodStatus, err error)
...
type secretProviderClassPodStatusLister struct {
	listers.ResourceIndexer[*apisv1alpha1.SecretProviderClassPodStatus]
}
...
func NewSecretProviderClassPodStatusLister(indexer cache.Indexer) SecretProviderClassPodStatusLister {
	return &secretProviderClassPodStatusLister{listers.New[*apisv1alpha1.SecretProviderClassPodStatus](indexer, apisv1alpha1.Resource("secretproviderclasspodstatus"))}
}
...
func (s *secretProviderClassPodStatusLister) SecretProviderClassPodStatuses(namespace string) SecretProviderClassPodStatusNamespaceLister {
	return secretProviderClassPodStatusNamespaceLister{listers.NewNamespaced[*apisv1alpha1.SecretProviderClassPodStatus](s.ResourceIndexer, namespace)}
}
...
type SecretProviderClassPodStatusNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apisv1alpha1.SecretProviderClassPodStatus, error)
