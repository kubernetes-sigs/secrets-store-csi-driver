...
| `controllerName`                        | The name of the SecretSync Controller.                                                                              | `secret-sync-controller-controller-manager`                   |
...
| `rotationPollIntervalInSeconds`         | How quickly the SecretSync Controller checks or updates the secret it is managing.                                  | `21600s` (6 hours)                                             |
